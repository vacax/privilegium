...
public class UsuarioView extends Div implements AfterNavigationObserver {
    ...
    public UsuarioView(UsuarioService usuarioServices, RoleService rolesServices) {
        setId("crud-usuario-view");
        setSizeFull();
        HorizontalLayout layout = new HorizontalLayout();
        GridCrud<Usuario> crud = new GridCrud<>(Usuario.class);
        crud.getGrid().setColumns("username", "nombre", "correo", "administrador" , "habilitado", "listaRoles" );
        crud.getCrudFormFactory().setVisibleProperties("username", "password", "nombre", "administrador", "correo", "habilitado", "listaRoles");
        //
